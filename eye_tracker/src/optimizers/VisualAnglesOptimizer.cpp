...
namespace et
{
    int VisualAnglesOptimizer::getDims() const
    {
        return 3;
    }

    double VisualAnglesOptimizer::calc(const double *x) const
    {
        double error = 0.0f;
    ...
    void
    VisualAnglesOptimizer::setParameters(std::vector<cv::Point3d> front_corners, std::vector<cv::Point3d> back_corners,
    ...
    cv::Vec3d VisualAnglesOptimizer::getCrossPoint() const
    {
        return cross_point_;
    }

    VisualAnglesOptimizer::VisualAnglesOptimizer()
    {
